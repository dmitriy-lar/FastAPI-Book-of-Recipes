...
@router.get('/category/list', status_code=status.HTTP_200_OK, response_model=List[CategoryIngredientScheme],
            summary='List of categories of ingredients', response_description='List of categories')
...
@router.put('/category/update/{category_id}', status_code=status.HTTP_200_OK, response_model=CategoryIngredientScheme,
            summary='Update a category of ingredients', response_description='Updated category')
async def update_category(category_id: int, category_scheme: CategoryIngredientScheme, db: Session = Depends(get_db)):
    """
...
@router.delete('/category/delete/{category_id}', status_code=status.HTTP_204_NO_CONTENT, summary='Delete a category')
...
@router.get('/category/{category_id}', response_model=CategoryIngredientScheme, status_code=status.HTTP_200_OK,
